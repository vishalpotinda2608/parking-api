...
function createCypherDirectiveSubquery({ cypherField, nodeRef, resultVariable, extraArgs, }) {
    ...
    const rawCypher = new cypher_builder_1.default.RawCypher(cypherField.statement);
    ...
    return cypher_builder_1.default.concat(callClause, new cypher_builder_1.default.RawCypher(() => {
        return ["", extraArgs];
    }));
}

...
function createConnectionWherePropertyOperation({ context, whereInput, edgeRef, targetNode, node, edge, listPredicateStr, }) {
    ...
    Object.entries(whereInput).forEach(([key, value]) => {
        if (key === "AND" || key === "OR") {
            ...
            if (key === "AND") {
                params.push(cypher_builder_1.default.and(...(0, utils_2.filterTruthy)(subOperations)));
                return;
            }
            if (key === "OR") {
                params.push(cypher_builder_1.default.or(...(0, utils_2.filterTruthy)(subOperations)));
                return;
            }
        }

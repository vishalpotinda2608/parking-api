...
function createConnectAndParams({ withVars, value, varName, relationField, parentVar, refNodes, context, callbackBucket, labelOverride, parentNode, fromCreate, insideDoWhen, includeRelationshipValidation, isFirstLevel = true, }) {
    function createSubqueryContents(relatedNode, connect, index) {
        ...
        const nodeMatrix = [{ node: relatedNode, name: nodeName }];
        if (!fromCreate)
            nodeMatrix.push({ node: parentNode, name: parentVar });
